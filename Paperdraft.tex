...
\begin{tabular}{cccc}
\hline
 & \textbf{IVS-INT1} & \textbf{IVS-INT2} & \textbf{Ru1} \\ \Xhline{1pt}
...
\textbf{East-West dimension (km)} & 10,072 & 10,072 &  \\
\textbf{North-South dimension (km)} & 2,414 & 2,414 &  \\
...
\textbf{Time frame of observations} & 19:00 - 20:00 & 08:30 - 09:30 & 18:30 - 19:30 \\ \hline
\end{tabular}
\end{table}
...
\begin{table}[]
\centering
\caption{Overview of UT1 estimates from legacy networks, \textit{where Est is the RMS value of estimates and Err is the mean error of the estimates}. }
\label{tab:rmsdut1}
\begin{tabular}{lllll}
\hline
Resolution & \multicolumn{2}{l}{1 day} & \multicolumn{2}{l}{1 hour} \\ \Xhline{1pt}
Network & Est & Err & Est & Err \\ \hline
Legacy-1 & 24.63 & 2.97 & 23.94 & 7.67 \\
Legacy-2 & 30.34 & 1.62 & 28.54 & 4.48 \\
\begin{tabular}[c]{@{}l@{}}Legacy-1 +\\ Legacy-2\end{tabular} & 27.16 & 1.47 & 25.06 & 3.76 \\ \hline
\end{tabular}
\end{table}
