...
% As the parameterization used for determining dUT1 from intensive sessions included many parameters not being estimated might.  
...
Legacy-1 & 24.70 & 2.97 & 23.94 & 7.63 \\
...
\begin{figure}
    ...
    \caption{Comparison of daily dUT1 estimates from Legacy networks with IVS intensives (top) and Russian intensives (bottom). \textit{Blue and Red lines represents Legacy-1 and Legacy-2 networks respectively; Magenta, cyan, and black represents dUT1 from IVS-INT1, IVS-INT2, and Russian intensives respectively}.}
    \label{fig:dut1int}
\end{figure}
